...
public class Step06ObjectOrientedTest extends PlainTestCase {
    ...
    public void test_objectOriented_polymorphism_interface_hierarchy() {
        ...
        assertEquals(sea, "jiri jiri jiri---");
    ...
    public void test_objectOriented_polymorphism_interface_runnerImpl() {
        ...
        Animal landAnimal = new Dog();
        boolean isFastRunner = landAnimal instanceof FastRunner;
        assertTrue(isFastRunner);
    }
    ...
    public void test_objectOriented_polymorphism_makeConcrete() {
        ...
        BarkedSound barkedSound = hamster.bark();
        assertEquals(barkedSound.getBarkWord(), "**squeak**");
        boolean isFastRunner = hamster instanceof FastRunner;
    ...
    public void test_objectOriented_polymorphism_makeInterface() {
        // your confirmation code here
        Animal hamster = new Hamster();
        String action = hamster.climb();
        log(action);
        assertEquals(action, "**climbing**");
    }
    ...
    public void test_objectOriented_writing_generalization_extractToAbstract() {
        ...
        SQL postgreSql = new St6PostgreSql();
        String queryMySql = mySql.buildPagingQuery(6, 2);
        String queryPostgreSql = postgreSql.buildPagingQuery(6, 2);
        assertEquals(queryMySql, "limit 6, 6");
        assertEquals(queryPostgreSql, "limit 6, 6");
    }
    ...
    public void test_objectOriented_writing_specialization_extractToConcrete() {
        // your confirmation code here
        St6OperationSystem macOS = new MacOS("marcin");
        St6OperationSystem windows = new Windows("marcin");
        St6OperationSystem oldWindows = new OldWindows("marcin");
        String resource = "javatry/tutorial";
        String macOsPath = macOS.buildUserResourcePath(resource);
        String windowsPath = windows.buildUserResourcePath(resource);
        String oldWindowsPath = oldWindows.buildUserResourcePath(resource);
        assertEquals(macOsPath, "/Users/marcin/javatry/tutorial");
        assertEquals(windowsPath, "\\Users\\marcin\\javatry\\tutorial");
        assertEquals(oldWindowsPath, "\\Documents and Settigs\\marcin\\javatry\\tutorial");
    }
    ...
    public void test_objectOriented_writing_withDelegation() {
        ...
        try {
            ...
            log(e.getMessage());
            assertEquals(e.getMessage(), "I'm very tired, so I want to sleep**squeak**");
        }
    }
